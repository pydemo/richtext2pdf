...
class RichTextFrame(wx.Frame):
    ...
    def MakeToolBar(self):
        ...
        doBind( tbar.AddTool(wx.ID_OPEN, "Open", images._rt_open.GetBitmap(),
                            shortHelp="Open"), self.OnFileOpen)
        doBind( tbar.AddTool(wx.ID_SAVE, "Save", images._rt_save.GetBitmap(),
                            shortHelp="Save"), self.OnFileSave)
        tbar.AddSeparator()
        doBind( tbar.AddTool(wx.ID_CUT, "Cut", images._rt_cut.GetBitmap(),
                            shortHelp="Cut"), self.ForwardEvent, self.ForwardEvent)
        doBind( tbar.AddTool(wx.ID_COPY, "Copy", images._rt_copy.GetBitmap(),
                            shortHelp="Copy"), self.ForwardEvent, self.ForwardEvent)
        doBind( tbar.AddTool(wx.ID_PASTE, "Paste", images._rt_paste.GetBitmap(),
                            shortHelp="Paste"), self.ForwardEvent, self.ForwardEvent)
        tbar.AddSeparator()
        doBind( tbar.AddTool(wx.ID_UNDO, "Undo", images._rt_undo.GetBitmap(),
                            shortHelp="Undo"), self.ForwardEvent, self.ForwardEvent)
        doBind( tbar.AddTool(wx.ID_REDO, "Redo", images._rt_redo.GetBitmap(),
                            shortHelp="Redo"), self.ForwardEvent, self.ForwardEvent)
        tbar.AddSeparator()
        doBind( tbar.AddTool(wx.ID_ANY, "Bold", images._rt_bold.GetBitmap(), 
                            kind=wx.ITEM_CHECK, shortHelp="Bold"), self.OnBold, self.OnUpdateBold)
        doBind( tbar.AddTool(wx.ID_ANY, "Italic", images._rt_italic.GetBitmap(), 
                            kind=wx.ITEM_CHECK, shortHelp="Italic"), self.OnItalic, self.OnUpdateItalic)
        doBind( tbar.AddTool(wx.ID_ANY, "Underline", images._rt_underline.GetBitmap(), 
                            kind=wx.ITEM_CHECK, shortHelp="Underline"), self.OnUnderline, self.OnUpdateUnderline)
        tbar.AddSeparator()
        doBind( tbar.AddTool(wx.ID_ANY, "Align Left", images._rt_alignleft.GetBitmap(), 
                            kind=wx.ITEM_CHECK, shortHelp="Align Left"), self.OnAlignLeft, self.OnUpdateAlignLeft)
        doBind( tbar.AddTool(wx.ID_ANY, "Center", images._rt_centre.GetBitmap(), 
                            kind=wx.ITEM_CHECK, shortHelp="Center"), self.OnAlignCenter, self.OnUpdateAlignCenter)
        doBind( tbar.AddTool(wx.ID_ANY, "Align Right", images._rt_alignright.GetBitmap(), 
                            kind=wx.ITEM_CHECK, shortHelp="Align Right"), self.OnAlignRight, self.OnUpdateAlignRight)
        tbar.AddSeparator()
        doBind( tbar.AddTool(wx.ID_ANY, "Indent Less", images._rt_indentless.GetBitmap(),
                            shortHelp="Indent Less"), self.OnIndentLess)
        doBind( tbar.AddTool(wx.ID_ANY, "Indent More", images._rt_indentmore.GetBitmap(),
                            shortHelp="Indent More"), self.OnIndentMore)
        tbar.AddSeparator()
        doBind( tbar.AddTool(wx.ID_ANY, "Font", images._rt_font.GetBitmap(),
                            shortHelp="Font"), self.OnFont)
        doBind( tbar.AddTool(wx.ID_ANY, "Font Color", images._rt_colour.GetBitmap(),
